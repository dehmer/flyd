...
describe('stream', function() {
  ...
  describe('Promises', function() {
    describe('fromPromise', function() {
      ...
      // long-runner
      it.skip('does not process out of order promises', function(done) {
        var promises = [];
    ...
    describe('flattenPromise', function() {
      ...
      // long-runner
      it.skip('processes out of order promises', function(done) {
        var promises = [];
        var delay = function(ms, val) {
          var p = new Promise(function(res) {
            setTimeout(function() {
  ...
  describe('chain', function() {
    ...
    // not a test at all
    it.skip('preserves ordering', function() {
      function delay(val, ms) {
        var outStream = flyd.stream()
        setTimeout(() => outStream(val), ms);
        return outStream;
      }

      var s = stream();

      var s2 = s.chain(val => delay(val, 100))
      s(1)(2)(3)(4);
